...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYXZyb3JpbGthIiwiYSI6ImNranprMndhcTA4NzYydmxpamc5aWNiOXUifQ.cFxlPHlrCF_MgW6xCh5ulg';
...
var showAlert = function showAlert(type, msg) {
  var alertHTML = "<div class=\"alert alert-".concat(type, " alert-dismissible fade show\" role=\"alert\">\n                      <strong>\u041F\u043E\u0432\u0456\u0434\u043E\u043C\u043B\u0435\u043D\u043D\u044F</strong> ").concat(msg, "!\n                      <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\">\n                      <span aria-hidden=\"true\">&times</span></button></div>");
...
exports.deleteMe = exports.signup = exports.logout = exports.login = void 0;
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Спроба увійти до облікового запису пройшла успішно!');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Помилка при спробі вийти з облікового запису! Спробуйте ще раз');
...
var signup = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(email, name, password, passwordConfirm) {
    var res;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Успішне створення облікового запису!');
              window.setTimeout(function () {
                location.assign('/me');
              }, 1500);
            }
...
var deleteMe = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(email, name, password, passwordConfirm) {
    var res;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Помилка при спробі видалити обліковий запис!');
  ...
  return function deleteMe(_x7, _x8, _x9, _x10) {
...
exports.updateRecord = exports.updateSettings = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " \u0434\u0430\u043D\u043D\u0456 \u043E\u043D\u043E\u0432\u043B\u0435\u043D\u0456 \u0443\u0441\u043F\u0456\u0448\u043D\u043E!"));
              window.setTimeout(function () {
                location.assign('/me');
              }, 1500);
            }
...
var updateRecord = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(userID, name, email, role) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "\u0414\u0430\u043D\u043D\u0456 \u043E\u043D\u043E\u0432\u043B\u0435\u043D\u0456 \u0443\u0441\u043F\u0456\u0448\u043D\u043E!");
              window.setTimeout(function () {
  ...
  return function updateRecord(_x3, _x4, _x5, _x6) {
    return _ref2.apply(this, arguments);
  };
}();
...
var bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId, tourPrice) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "http://127.0.0.1:3000/api/v1/bookings/createBookingRecord/".concat(tourId),
              data: {
                price: tourPrice
              }
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Тур був успішно заброньований!');
            }
...
exports.updateReview = exports.newReview = void 0;
...
var newReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId, stars, text) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "http://127.0.0.1:3000/api/v1/reviews/sendNewReview/".concat(tourId),
              data: {
                review: text,
                rating: stars
              }
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Дякуємо за відгук!');
            }
  ...
  return function newReview(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();
...
var updateReview = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(reviewID, stars, text) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"tableManager.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.editRecord = exports.deleteRecord = void 0;
...
var deleteRecord = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(dataType, dataId) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'DELETE',
              url: "http://127.0.0.1:3000/api/v1/".concat(dataType, "/").concat(dataId)
            });
  ...
  return function deleteRecord(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
var editRecord = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(dataType, dataId) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "http://127.0.0.1:3000/update-".concat(dataType, "/").concat(dataId)
            });
          ...
          case 7:
            _context2.prev = 7;
            _context2.t0 = _context2["catch"](0);
            (0, _alerts.showAlert)('error', 'Помилка при спробі завантажити інфо про обліковий запис!');
  ...
  return function editRecord(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
...
exports.createTourRecord = exports.updateTourRecord = void 0;
...
var updateTourRecord = /*#__PURE__*/function () {
  ...
  return function updateTourRecord(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.updateTourRecord = updateTourRecord;

var createTourRecord = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(name, duration, maxGroupSize, price, difficulty, summary, description, coordinates) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "\u0421\u0442\u0432\u043E\u0440\u0435\u043D\u043D\u044F \u0442\u0443\u0440\u0443 \u043F\u0440\u043E\u0439\u0448\u043B\u043E \u0443\u0441\u043F\u0456\u0448\u043D\u043E!");
              window.setTimeout(function () {
                location.assign('/all-tours');
              }, 500);
            }
  ...
  return function createTourRecord(_x3, _x4, _x5, _x6, _x7, _x8, _x9, _x10) {
    return _ref2.apply(this, arguments);
  };
}();

exports.createTourRecord = createTourRecord;
...
var delMeButton = document.getElementById('delMe');
var userDataForm = document.querySelector('.form-user-data');
var userUpdateRecord = document.querySelector('.form-user-data-update');
var userPasswordForm = document.querySelector('.form-user-password');
var updateTourForm = document.querySelector('.update-tour-form');
var createTourForm = document.querySelector('.create-tour');
var sendReviewButton = document.getElementById('send-review');
var updateReviewButton = document.getElementById('update-review');
var bookButton = document.getElementById('book-tour');
var openAsideButton = document.getElementById('asideBtn');
var closeAsideButton = document.getElementById('closebtn');
var editTableRecord = document.querySelectorAll('.change');
var delTableRecord = document.querySelectorAll('.del');
...
if (openAsideButton) openAsideButton.addEventListener('click', function (e) {
  document.getElementById('mySidenav').style.width = '250px';
});
if (closeAsideButton) closeAsideButton.addEventListener('click', function (e) {
...
if (signupForm) signupForm.addEventListener('submit', function (e) {
  ...
  (0, _auth.signup)(email, name, password, passwordConfirm);
});
if (logOutButton) logOutButton.addEventListener('click', _auth.logout);
if (delMeButton) delMeButton.addEventListener('click', _auth.deleteMe);
...
if (userUpdateRecord) {
  userUpdateRecord.addEventListener('submit', function (e) {
    e.preventDefault();
    ...
    (0, _updateSettings.updateRecord)(userId, name, email, role);
  });
}
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            document.querySelector('.btn-save-password').textContent = 'Зберегти пароль';
...
if (sendReviewButton) sendReviewButton.addEventListener('click', function (e) {
  var tourId = e.target.dataset.tourId;
  var stars = Number(document.getElementById('stars').value);
  var text = document.getElementById('reviewText').value;
  (0, _review.newReview)(tourId, stars, text);
});
if (updateReviewButton) updateReviewButton.addEventListener('click', function (e) {
  e.preventDefault();
  var reviewId = e.target.dataset.id;
  var stars = Number(document.getElementById('stars').value);
  var text = document.getElementById('reviewText').value;
  (0, _review.updateReview)(reviewId, stars, text);
});
if (bookButton) bookButton.addEventListener('click', function (e) {
  e.target.textContent = 'Додаємо...';
  var tourId = e.target.dataset.tourId;
  var tourPrice = e.target.dataset.tourPrice;
  (0, _booking.bookTour)(tourId, tourPrice);
  e.target.textContent = 'Готово!';
});
if (editTableRecord) editTableRecord.forEach(function (item) {
  item.addEventListener('click', function (e) {
    var dataType = e.target.dataset.type;
    var dataId = e.target.dataset.id;
    (0, _tableManager.editRecord)(dataType, dataId);
  });
});
if (delTableRecord) delTableRecord.forEach(function (item) {
  item.addEventListener('click', function (e) {
    var dataType = e.target.dataset.type;
    var dataId = e.target.dataset.id;
    (0, _tableManager.deleteRecord)(dataType, dataId);
  });
});
if (updateTourForm) updateTourForm.addEventListener('submit', function (e) {
  ...
  (0, _tours.updateTourRecord)(tourId, form);
});
